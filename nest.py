...
THRESHOLDS = {
    "green":  {"time": 60, "gap": 15, "start": 20},
    "yellow": {"time": 60, "gap": 15, "start": 20},
    "red":    {"time": 30, "gap": 5, "start": 10},
    "blue":   {"time": 30, "gap": 5, "start": 10},
}
...
exp_list = ['male_P35','female_P42']   #LIST OF FOLDERS
